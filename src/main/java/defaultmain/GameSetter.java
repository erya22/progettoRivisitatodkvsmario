...
public class GameSetter {
    ...
    public void setupGame() {
        // Crea sprite mappe
        HashMap<SimpleEntry<ActionState, Direction>, BufferedImage[]> spriteFrames = new HashMap<>();
        HashMap<SimpleEntry<ActionState, Direction>, BufferedImage[]> spriteFramesDK = new HashMap<>();

        // Crea Player
        player = new Player(0, 0, 4, 0, Constants.TILE_SIZE, Constants.TILE_SIZE, spriteFrames, "Mario", 0, 0, 10, 1, 12);
        ...
        mapView = new MapView();
        panel = new GamePanel(player, dk, pcontroller, mapView);
    }
