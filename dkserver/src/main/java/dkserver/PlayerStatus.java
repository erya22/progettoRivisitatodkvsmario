...
/**
 * Rappresenta lo stato di un giocatore in una sessione di gioco.
 */
public class PlayerStatus implements Serializable {
	...
	/**
     * Costruttore.
     * @param nickname il nome identificativo del giocatore
     * @param score il punteggio attuale
     * @param vite il numero di vite rimanenti
     * @param alive true se il giocatore è vivo, false altrimenti
     */
